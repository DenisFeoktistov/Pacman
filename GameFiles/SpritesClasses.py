...
class GhostSprite(GeneralSprite):
    ...
    def __init__(self, x, y, sprite_size_x, sprite_size_y, cycle_time, color="red"):
        if color not in ["red", "pink", "blue", "orange"]:
            color = "red"
        frames = ((f'data/sprites/ghosts/{color}_right1.png', f'data/sprites/ghosts/{color}_right2.png'),
                  (f'data/sprites/ghosts/{color}_up1.png', f'data/sprites/ghosts/{color}_up2.png'),
                  (f'data/sprites/ghosts/{color}_left1.png', f'data/sprites/ghosts/{color}_left2.png'),
                  (f'data/sprites/ghosts/{color}_down1.png', f'data/sprites/ghosts/{color}_down2.png'))
        default_frame = f'data/sprites/ghosts/{color}_up1.png'
        super().__init__(x, y, sprite_size_x=sprite_size_x, sprite_size_y=sprite_size_y,
