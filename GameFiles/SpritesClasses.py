...
class PacmanSprite(GeneralSprite):
    def __init__(self, x, y, sprite_size, cycle_time):
        ...
        super().__init__(x, y, sprite_size=sprite_size, cycle_iterations=12, switches_for_cycle=4,
                         cycle_time=cycle_time, default_frame=default_frame, frames=frames)
